...
- words are introduced
    - first going from Arabic to English e.g., <span className="text-3xl">بَهَذَ</span> to "to go",
    - then English to Arabic, e.g., "to go" to <span className="text-3xl">بَهَذَ</span>
...
words are pronounced, e.g., "to drink" is ب َر orَ * ش ُ ر َب notَ
, ش ِ ر َب .* َش َ (Compare whether other products handle voweling
correctly, both in reading Arabic and in writing Arabic.)

- grammar points needed to master vocabulary are included. Not only
is رب ٌحَ included meaning "war" or "warfare," but it is also
marked as feminine. Not only is ف َر َعَ included meaning "to
know," "to recognize," or "to be aware of," but its present ِ ع ر
َف singular masculine َي is also included, not ف َر عَ only Notَ
*. ي ُ ع ر َف orَ * ي is ير ب ٌ ك َincluded meaning "big" or
"great," but its masculine plural, ار ب ٌ ك , ِis also included.
